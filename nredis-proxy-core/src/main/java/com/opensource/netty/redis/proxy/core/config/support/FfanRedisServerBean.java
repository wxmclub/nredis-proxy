 ...
 *
 */
public class FfanRedisServerBean implements RedisWeight{
	 ...
	 * @param minConnection
	 */
	public FfanRedisServerBean(String host, int port, int timeout,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FfanRedisServerBean other = (FfanRedisServerBean) obj;
		if (host == null) {
			if (other.host != null)
				return false;
