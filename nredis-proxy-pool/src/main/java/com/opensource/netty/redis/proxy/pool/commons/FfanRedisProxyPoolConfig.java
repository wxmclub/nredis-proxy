...
import com.opensource.netty.redis.proxy.pool.exception.FfanRedisProxyPoolPropertyValidationException;
 ...
 *
 */
public class FfanRedisProxyPoolConfig {
	...
	public void validatePropCorrelation() throws FfanRedisProxyPoolPropertyValidationException {
		if (maxActiveEntries < initialEntries)
			throw new FfanRedisProxyPoolPropertyValidationException(
